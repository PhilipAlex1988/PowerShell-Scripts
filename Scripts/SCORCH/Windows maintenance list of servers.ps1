...
# AUTHOR:  Philip Alex 
# DATE:    07/06/2017
# Name:    Windows Maintenance list of servers.ps1
# Version: 1.0
# COMMENT: Puts a list of Windows Servers in Maintenance Mode in SCOM 2012
#============================================================================

#========================================================================================================
# Script Usage
# & '.\Windows maintenance list of servers.ps1' -TimeMin 30 -Reason PlannedOther -Comment "INC000005423"
#========================================================================================================
...
# UnplannedApplicationMaintenance, ApplicationInstallation, ApplicationUnresponsive, ApplicationUnstable, SecurityIssue, LossOfNetworkConnectivity"
#====================================================================================================================================================
...
param([int32]$TimeMin, [string]$Reason, [string]$Comment)
                 ...
                 Foreach ($Server in $Servers)
                 {
                                 ...
                                 $api.LogScriptEvent('Windows maintenance list of servers.ps1', 201, 1, "$Server already found under MM, skipped from script execution")
                                 }
                                 Else
                                 {
                                 ...
                                 If ($ComputerClassInstance -ne $Null)
                                 {
                                                 ...
                                                 $api.LogScriptEvent('Windows maintenance list of servers.ps1', 200, 0, "$Server kept in maintenance mode for $TimeMin minutes")
                                 }
                                 Else
                                 {
                                                 Write-Host $Server" not found in Domain" -foregroundcolor "red"
                                                 $api.LogScriptEvent('Windows maintenance list of servers.ps1', 202, 1, "$Server not found in domain")
                                 }
                                 }
                 }
